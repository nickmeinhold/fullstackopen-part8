...
const resolvers = {
  ...
  Mutation: {
    ...
    addBook: async (root, args, context) => {
      console.log("addBook mutation called with:", args);
      console.log("currentUser:", context.currentUser?.username || "null");
      ...
      try {
        ...
        console.log("Publishing BOOK_ADDED event for:", populatedBook.title);
